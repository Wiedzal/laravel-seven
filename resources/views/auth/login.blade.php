	...
	<div class="row">
		<div class="col-md-8 col-md-offset-2">
			<div class="panel panel-default">
				<div class="panel-heading">{{ trans('auth.authorization') }}</div>
				<div class="panel-body">
					...
					{!! Form::open(['route' => 'auth.login', 'class' => 'form-horizontal']) !!}		
						...
						<div class="form-group">
							<div class="col-md-6 col-md-offset-4">
								<button type="submit" class="btn btn-primary">{{ trans('auth.log_in') }}</button>
								<a class="btn btn-link" href="{{ url('/password/email') }}">{{ trans('auth.password_forgot') }}?</a>
							</div>
						</div>
					{!! Form::close()!!}
				</div>
